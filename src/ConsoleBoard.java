...
public class ConsoleBoard {
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			try (BufferedWriter bw = new BufferedWriter(new FileWriter("CB.txt"));
					BufferedReader br = new BufferedReader(new FileReader("CB.txt"))) {
				...
				while (true) {
					...
					case 1:
						...
						for (Board board : boardList) {
							System.out.print(" " + board.getNumber() + "  " + board.getTitle() + "  "
					...
					case 2:
						...
						System.out.println("작성하신 게시글 번호는 " + boardNumber + "번 입니다.");
						break;
					...
					case 3:
						...
						for (Board board1 : boardList) {
							System.out.print(" " + board1.getNumber() + "  " + board1.getTitle() + "  "
									+ board1.getWriter() + "     " + board1.getDate());
							System.out.println();
						}
						System.out.println();
